...
export class MobileMenuToggle {
    ...
    onSubMenuClick(event) {
        ...
        if ($closestAction.hasClass('is-open')) {
            $parentSiblings.addClass('is-hidden');
            $parentAction.addClass('is-hidden');
            $parentAction.siblings('.navPage-subMenu').addClass('is-hidden');
            ...
            $parentAction.siblings('.navPage-subMenu').removeClass('is-hidden');
            $closestAction.closest('.cateArea').siblings('.imageArea.colRight').removeClass('is-hidden');
        }
    }
